  ...
  return (
    <QueryClientProvider client={queryClient}>
      <MathJaxContext config={MATHJAX_CONFIG}>
        <header className="flex select-none flex-col items-center justify-center gap-2 max-sm:mb-2 max-sm:flex max-sm:flex-row max-sm:items-center max-sm:justify-between">
          <Button
