    ...
    {categories
      ...
      .map((category) => (
        <a
          ...
          className="text-sm sm:opacity-0 max-sm:hidden pointer-events-none sm:group-hover:pointer-events-auto active:scale-95 sm:group-hover:opacity-100 sm:scale-95 sm:group-hover:scale-100 transition-all font-mono text-zinc-800 bg-zinc-50 hover:bg-zinc-100 border border-zinc-200 rounded-full px-2.5 py-0.5"
